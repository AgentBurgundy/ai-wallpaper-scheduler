/**
 * Setup script for executable version
 * This version works when running as a bundled executable
 */
...
const examplePath = path.join(appDir, 'env.example.txt');
...
`;
    ...
    console.log('\n🎉 Setup complete!');
    console.log('\nNext steps:');
    console.log('  Run: screensaver.exe');
    console.log('  (Optional) Set up Windows Task Scheduler for daily updates\n');
